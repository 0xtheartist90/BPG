...
export const BPGPage = ({ dict, locale, articles, events }: BPGPageProps) => {
        ...
        <main className='bg-background text-foreground'>
            ...
            <div className='relative bg-[#d06129] text-white'>
                <SectionWrapper id='nieuws' className='text-white'>
                    ...
                    <div className='mt-10'>
                        <NewsShowcase locale={locale} newsControls={dict.newsControls} articles={articles} />
                    </div>
                </SectionWrapper>
            </div>
